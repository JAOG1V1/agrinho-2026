...
<table>
  <tr>
    <td align="center" width="50%">
      ...
      <img src="screenshots/01-hero-home.png" alt="Página inicial do Agro Forte no tema claro com hero, título Agro forte futuro sustentável e ilustração SVG do campo" width="100%">
    </td>
    <td align="center" width="50%">
      <strong>🌙 Tema Escuro</strong><br><br>
      <img src="screenshots/02-hero-escuro.png" alt="Mesma página inicial do Agro Forte agora no tema escuro demonstrando o modo dark com cores ajustadas" width="100%">
    </td>
  </tr>
</table>
...
<table>
  <tr>
    <td align="center" width="50%">
      ...
      <img src="screenshots/04-simulador.png" alt="Simulador de Fazenda Sustentável com lotes preenchidos contendo Energia Solar Irrigação e Plantio Direto além de indicadores em tempo real" width="100%">
    </td>
    <td align="center" width="50%">
      <strong>🏆 Resultado: Fazenda Modelo</strong><br><br>
      <img src="screenshots/05-resultado-fazenda.png" alt="Tela de resultado do simulador alcançando o nível Fazenda Modelo com pontuação total de 367 pontos" width="100%">
    </td>
  </tr>
  <tr>
    <td align="center" width="50%">
      <strong>🧠 Quiz Interativo</strong><br><br>
      <img src="screenshots/07-quiz-pergunta.png" alt="Quiz interativo em andamento mostrando pergunta sobre erosão do solo botão de ouvir pergunta e conquista Colecionador desbloqueada" width="100%">
    </td>
    <td align="center" width="50%">
      <strong>🛡️ Defensor do Agro</strong><br><br>
      <img src="screenshots/03-jogo-em-acao.png" alt="Mini-jogo Defensor do Agro rodando com cenário rural completo e conquista Guardião do Campo desbloqueada na lateral" width="100%">
    </td>
  </tr>
</table>
...
<table>
  <tr>
    <td align="center" width="50%">
      ...
      <img src="screenshots/06-mapa-brasil.png" alt="Mapa interativo do Brasil com a região Sul selecionada e Paraná destacado em dourado conquista Mapa Decifrado desbloqueada" width="100%">
    </td>
    <td align="center" width="50%">
      <strong>🌱 Práticas Sustentáveis</strong><br><br>
      <img src="screenshots/08-praticas-solo.png" alt="Página de práticas sustentáveis com filtro Solo ativo exibindo três cards Plantio Direto Rotação de Culturas e Bioinsumos" width="100%">
    </td>
  </tr>
</table>
...
<br><br>
<img src="screenshots/09-glossario.png" alt="Glossário do agro sustentável com filtros alfabéticos por letra e termos técnicos organizados em formato acordeão" width="75%">
...
<table>
  <tr>
    <td align="center" width="33%">
      ...
      <img src="screenshots/12-comparador-antes.png" alt="Comparador exibindo cem por cento o lado Antes Solo degradado com cores marrons áridas e troncos secos" width="100%">
    </td>
    <td align="center" width="33%">
      <strong>↔️ Transição</strong><br><br>
      <img src="screenshots/10-comparador-meio.png" alt="Comparador interativo mostrando metade solo degradado e metade solo restaurado evidenciando a transição entre os dois cenários" width="100%">
    </td>
    <td align="center" width="33%">
      <strong>🌿 Solo Restaurado</strong><br><br>
      <img src="screenshots/11-comparador-depois.png" alt="Comparador exibindo cem por cento o lado Depois Solo restaurado com vegetação verde árvores e ambiente vivo" width="100%">
    </td>
  </tr>
</table>
...
<br><br>
<img src="screenshots/13-mobile-home.png" alt="Versão mobile responsiva da página inicial do Agro Forte com menu hambúrguer adaptado para telas pequenas" width="35%">
